...
'''
save_error_data_path = r"F:\研究生\论文\事件检测论文\基于AICSW事件检测算法的电器能效分析\25年4月版\程序\金卡数据集\金卡数据\测试数据\测试输出结果\error_data.csv"
save_lose_data_path = r"F:\研究生\论文\事件检测论文\基于AICSW事件检测算法的电器能效分析\25年4月版\程序\金卡数据集\金卡数据\测试数据\测试输出结果\lose_data.csv"
save_error_data_index_path = r"F:\研究生\论文\事件检测论文\基于AICSW事件检测算法的电器能效分析\25年4月版\程序\金卡数据集\金卡数据\测试数据\测试输出结果\error_data_index.csv"
save_lose_data_index_path = r"F:\研究生\论文\事件检测论文\基于AICSW事件检测算法的电器能效分析\25年4月版\程序\金卡数据集\金卡数据\测试数据\测试输出结果\lose_data_index.csv"
